...
//    public function __construct($host = '192.168.126.1', $username = 'desa', $password = 'desa', $db = 'hostelv2', $port = NULL) {
    public function __construct($host ='192.185.4.175', $username = 'arielces_desarro', $password = 'ehGwLk[T-sls', $db = 'arielces_desarrollos', $port = NULL) {
//        public function __construct($host = 'localhost', $username = 'root', $password = 'concentrador', $db = 'ac_desarrollos', $port = NULL) {
        $this->host = $host;
